...
bool NexObject::compare(const NexObject* n) const {
    // if (__pid != n->__pid) {
    //     Serial.println("pid not matching");
    //     return false;
    // }
    // if (__cid != n->__cid) {
    //     Serial.println("cid not matching");
    //     return false;
    // }
    // if (__name != n->__name) {
    //     Serial.println("name not matching");
    //     return false;
    // }
    // return true;
    return
