...
enum Parameter {
    ...
    PARAMETER_HEATUP_D_TERM,
    PARAMETER_HEATUP_I_TERM,
    PARAMETER_HEATUP_P_TERM,
    PARAMETER_SOAK_D_TERM,
    PARAMETER_SOAK_I_TERM,
    PARAMETER_SOAK_P_TERM,
    PARAMETER_REFLOW_D_TERM,
    PARAMETER_REFLOW_I_TERM,
    PARAMETER_REFLOW_P_TERM,
